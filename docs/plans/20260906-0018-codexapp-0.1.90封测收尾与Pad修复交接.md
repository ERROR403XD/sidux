...
严格 `noUnusedLocals/noUnusedParameters` 诊断由 59 条降到 33 条，未将余下诊断自动批量删除。保留问题及原始设计缺口继续见 [0017](20260906-0017-codexapp-0.1.90封测前最终代码与功能审查.md)：R05 异步问题、R06 工具历史、R07 动态模型能力、R08 PWA 离线缓存和 ACP 原始未完成方案进入 0.2，不宣称已实现。
