...
status: 模型能力候选已验证；新增 API 出口另见待审阅方案
---

# CodexApp 0.2.0 模型能力实施与验收

> 范围补充：用户随后要求 0.2.0 增加反代 API 出口，详见 [0024 实施方案](20260906-0024-codexapp-0.2.0反代API出口实施方案.md)。Codex CLI 为绝对核心，Claude Code 和聊天客户端均可选。本文件记录的 282 项测试、镜像与 UI 验收只覆盖已有模型能力；API 出口目前仅有调研/方案，未开发部署。原候选保持运行。
