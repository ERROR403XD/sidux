...
> 本文保留上一轮候选的历史验收记录。最新 Goal 入口、自动化配置、统一弹窗与发布包，以 [0015 目标入口与自动化封测修订](20260906-0015-codexapp-0.1.90目标入口与自动化封测修订.md) 为准。
...
[0.2 路线图](20260906-0012-codexapp-0.2系列代码审查与开发路线图.md) 已同步修订：Goal 基础管理、M/B 预算、压缩入口和固定队列语义属于 0.1.90 已交付基线；0.2.4 继续完善复杂状态、子任务用量与完整压缩反馈；常驻卡片已由 0015 修订提前补齐，其他优化顺序保留。
